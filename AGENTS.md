...
This project is indexed by GitNexus as **contrabass** (17108 symbols, 33594 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
