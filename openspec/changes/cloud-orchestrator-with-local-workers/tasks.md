...
- [x] 10.7 Wire metrics emission to Workers Analytics Engine
- [x] 10.8 Vitest coverage with mocked Linear/GitHub clients
...
- [x] 16.6 Validate config-changed propagation across multiple connected workers and dashboards
- [x] 16.7 Capture observability dashboards: poll latency, dispatch latency, lease-revocation rate, event ingest rate
